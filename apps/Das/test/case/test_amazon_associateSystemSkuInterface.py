...
def test_amazonAssociateSySkuInterface():
    ...
    responseResult01 = AmazonAssociateSystemSkuInterface().associateSystemSku("第一个用例",resultList, systemSkuStr01)
    ...
    responseResult02 = AmazonAssociateSystemSkuInterface().associateSystemSku("第二个用例",resultList, systemSkuStr02)
