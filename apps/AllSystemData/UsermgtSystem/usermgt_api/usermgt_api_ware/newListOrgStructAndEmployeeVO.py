...
#!/usr/bin/python3
'''
@File: newListOrgStructAndEmployeeVO
@time:2022/5/18
@Author:majiaqin 170479
@Desc:根据平台和工号获取级联获取员工信息
'''
import pprint
...
class NewListOrgStructAndEmployeeVOApi():
    def __init__(self):
        pass
...
if __name__ == '__main__':
    pprint.pprint(NewListOrgStructAndEmployeeVOApi().splicing_params_list())
    pass