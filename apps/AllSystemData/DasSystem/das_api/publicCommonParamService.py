...
def getAmazonApiInputParam(searchType):
    ...
    if searchType == "bestsellerMark_query":  # bestseller页面
        otherTypeListing03 = deepcopy(DasApiInputParam.amazon_bestsellersListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.amazon_NewReleaseListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.amazon_MoversShakersListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.amazon_MostWishedForListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.amazon_GiftldeasListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.amazon_attentStoreListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.amazon_categoryListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.amazon_keywordsListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.amazon_jungleScoutListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.amazon_ProductInfo03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.amazon_unavailableListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.customizeMarkListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.classificateMonitorListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.keyWordsMonitorListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.shopMonitorListing03)
...
def getSmtApiInputParam(searchType):
    ...
    if searchType == "categoryMark_query":# 数据采集-SMTorder大于100查询页面
        otherTypeListing03 = deepcopy(DasApiInputParam.smt_categoryMarkListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.smt_bestsellerMarkListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.smt_shopMarkListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.smt_attentionCategoryMarkListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.smt_keywordMarkListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.smt_ProductInfo03)
...
def getAliApiInputParam(searchType):
    ...
    if searchType == "categoryMark_query":  # 数据采集-1688分类数据页面查询
        otherTypeListing03 = deepcopy(DasApiInputParam.ali_categoryMarkListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.ali_shopMarkListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.ali_attentionCategoryMarkListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.ali_keywordMarkListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.ali_productInfo03)
...
def getEbayApiInputParam(searchType):
    ...
    if searchType == "followMark_query": # 自定义采集-ebay页面查询
        otherTypeListing03 = deepcopy(DasApiInputParam.ebay_followMarkListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.ebay_categoryMarkListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.ebay_productInfo03)
...
def getShopeeApiInputParam(searchType):
    ...
    if searchType == "customizeMark_query": # 自定义采集-shopee
        otherTypeListing03 = deepcopy(DasApiInputParam.shopee_customizeMarkListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.shopee_shopMarkListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.shopee_attentionCategoryMarkListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.shopee_keywordMarkListing03)
        ...
        otherTypeListing03 = deepcopy(DasApiInputParam.shopee_productInfo03)
