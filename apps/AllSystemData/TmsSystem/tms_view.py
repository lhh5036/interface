...
tms_garder_path = os.path.dirname(os.path.realpath(__file__)) + "\\test\\case\\" # 获取物流系统测试用例文件路径
...
def run_tmsTestcaseExecute():
    ...
    os.popen('scp -r /home/InterfaceAutoTest/apps/AllSystemData/TmsSystem/report/{0}.html \
