...
def create_app(config_name):
    ...
    app.register_blueprint(das_view.das_api,
                           url_prefix="/interfaceTest/das/")
    # 在Flask对象中注册蓝图模块中的蓝图对象 fmis_view 中的 fmis_api
    app.register_blueprint(fmis_view.fmis_api,
                           url_prefix="/interfaceTest/fmis/")
    # 在Flask对象中注册蓝图模块中的蓝图对象 usermgt_view 中的 usermgt_api
    app.register_blueprint(usermgt_view.usermgt_api,
                           url_prefix="/interfaceTest/usermgt/")
    # 订单系统
    app.register_blueprint(sale_view.sale_api,
                           url_prefix="/interfaceTest/sale/")
    # 物流系统
    app.register_blueprint(tms_view.tms_api,
                           url_prefix="/interfaceTest/tms/")
    # 产品系统
    app.register_blueprint(product_view.product_api,
                           url_prefix="/interfaceTest/product/")
    # 采购系统
    app.register_blueprint(pms_view.pms_api,
                           url_prefix="/interfaceTest/pms/")
    # 仓库系统
    app.register_blueprint(wms_view.wms_api,
                           url_prefix="/interfaceTest/wms/")
    return app